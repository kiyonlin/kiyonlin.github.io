...
![图2-1 IEEE 802.2/802.3（RFC 1042）和以太网的封装格式（RFC 894）](/images/52im_1.png "图2-1 IEEE 802.2/802.3（RFC 1042）和以太网的封装格式（RFC 894）")
...
![图2-2 SLIP报文的封装](/images/52im_2.png "图2-2 SLIP报文的封装")
...
![图2-3 PPP数据帧的格式](/images/52im_3.png "图2-3 PPP数据帧的格式")
...
![图2-4 环回接口处理IP数据报的过程](/images/52im_4.png "图2-4 环回接口处理IP数据报的过程")
...
![图2-5 几种常见的最大传输单元（MTU）](/images/52im_5.png "图2-5 几种常见的最大传输单元（MTU）")
